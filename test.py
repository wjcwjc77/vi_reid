...
parser.add_argument('--resume', '-r', default='llcm_agw_p4_n6_lr_0.1_seed_0_best.t', type=str, help='resume from checkpoint')
...
parser.add_argument('--test-batch', default=8, type=int, metavar='tb', help='testing batch size')
